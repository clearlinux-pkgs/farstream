...
Version  : 0.2.9
Release  : 11
URL      : https://www.freedesktop.org/software/farstream/releases/farstream/farstream-0.2.9.tar.gz
Source0  : https://www.freedesktop.org/software/farstream/releases/farstream/farstream-0.2.9.tar.gz
Source1  : https://www.freedesktop.org/software/farstream/releases/farstream/farstream-0.2.9.tar.gz.asc
Source2  : 1D388E5A4ED9A2BB.pkey
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) 1D388E5A4ED9A2BB' gpg.status
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722967918
...
cp %{_builddir}/farstream-%{version}/COPYING %{buildroot}/usr/share/package-licenses/farstream/caeb68c46fa36651acf592771d09de7937926bb3 || :
export GOAMD64=v2
GOAMD64=v2
%make_install
